...

{
    ...
    "category": "section",
    "text": "We start by drawing 100 observations from a standard-normal random variable.The first step is to set up the environment:julia> using Random, Distributions\n\njulia> Random.seed!(123) # Setting the seedThen, we create a standard-normal distribution d and obtain samples using rand:julia> d = Normal()\nNormal(μ=0.0, σ=1.0)\n\njulia> x = rand(d, 100)\n100-element Array{Float64,1}:\n  0.376264\n -0.405272\n ...You can easily obtain the pdf, cdf, quantile, and many other functions for a distribution. For instance, the median (50th percentile) and the 95th percentile for the standard-normal distribution are given by:julia> quantile.(Normal(), [0.5, 0.95])\n2-element Array{Float64,1}:\n 0.0\n 1.64485The normal distribution is parameterized by its mean and standard deviation. To draw random samples from a normal distribution with mean 1 and standard deviation 2, you write:julia> rand(Normal(1, 2), 100)"
},
